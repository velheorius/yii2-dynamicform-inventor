...
Форк с https://github.com/wbraganca/yii2-dynamicform для поддержки проекта
...
```
php composer.phar require --prefer-dist velheorius/yii2-dynamicform-inventor "*"
```

or add

```
"velheorius/yii2-dynamicform-inventor": "*"
```
